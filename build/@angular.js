...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var events;
	try {
	    events = __webpack_require__(346);
	}
	catch (err) {
	}
	...
	// Timers
	var timers = __webpack_require__(348);
	...
	var crypto;
	try {
	    crypto = __webpack_require__(349);
	}
	catch (err) {
	}
	...
	var httpClient;
	try {
	    httpClient = __webpack_require__(350);
	}
	catch (err) {
	}
